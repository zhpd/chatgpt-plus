...
import { Avatar, Button, Card, Drawer, FloatButton, Input, InputRef, App, Popconfirm, Space, theme as antdTheme, Tooltip, Typography, Empty, Col, Row, Select, Tag, Badge, Alert } from 'antd'
...
import _datas from '@/data/prompt'
